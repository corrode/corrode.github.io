...
- [ntpd-rs](https://github.com/pendulum-project/ntpd-rs) - Memory-safe NTP implementation in Rust
...
- [dqlite](https://dqlite.io/) - Distributed SQLite for high-availability
- [Nova](https://docs.kernel.org/gpu/driver-uapi.html) - NVIDIA GPU kernel driver written in Rust
- [Rust for Linux](https://rust-for-linux.com/) - Project to add Rust support to the Linux kernel
- [NixOS](https://nixos.org/) - Linux distribution focused on reproducibility
