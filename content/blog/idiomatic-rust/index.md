...
<img src="idiomatic.svg" alt="Idiomatic Rust hero image" class="noinvert" />

Have you ever found yourself struggling to find comprehensive resources for writing ergonomic and idiomatic Rust code?

I certainly have.

Coming from a Python background, where guidelines like the [Zen of Python](https://peps.python.org/pep-0020/) or authorities like [Peter Norvig](https://norvig.com/) provided clear direction, I was at a loss in the Rust world.

So, what did I do? Inspired by my Python journey, I began assembling a repository of peer-reviewed articles, talks, and repositories to master idiomatic Rust. It's not just my project, though; it's a community effort. 

The list is [maintained on GitHub and open for contributions](https://github.com/mre/idiomatic-rust).
Below is a rendered version of this list for better readability.

I hope it will help you become a better Rust developer!

{% info(headline="Need hands-on support?", icon="crab") %}
Using Rust in production? I can help you and your team with making your Rust
code more idiomatic.
...
{% info(headline="Reach out for help", icon="crab") %}
If you are looking for Rust consulting, training, or contracting, I can help you and your team 
make the most out of Rust. [Get in touch.](/about)
{% end %}